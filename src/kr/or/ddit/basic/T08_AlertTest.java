...
public class T08_AlertTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ButtonType confirmResult = alertConfirm.showAndWait().get();	//get하면 버튼 타입을 반환 // Enum타입으로 객체
		...
		javaPrompt.setHeaderText("TextInputDialog창입니다."); // 출력 메시지

		// 창을 보이고 입력한 값을 읽어오기
		Optional<String> result = javaPrompt.showAndWait();	// 입력 할때까지 wait // Optional은 NullPoint안뜨게 내부적으로 아무것도 입력안받아도 null로 반환해줌.
