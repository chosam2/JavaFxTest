...
public class T18_BarChartTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		// X축, Y축을 이용한 Chart는 해당 측 객체를 생성한다.
		...
		BarChart<String, Number> bc = new BarChart<>(xAxis, yAxis);	// 생성자로 축을 받음
		...
		ser1.getData().add(new XYChart.Data<String, Number>("호주", 26000)); // getData()는 ObservableList 타입임.
		...
		// ObservableList로 이렇게 정의해서 해도되고 getData()로 해서 해도됨.
